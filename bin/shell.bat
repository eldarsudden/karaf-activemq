...
set CLASSPATH=%KARAF_HOME%\system\org\apache\karaf\shell\org.apache.karaf.shell.core\4.2.8\org.apache.karaf.shell.core-4.2.8.jar
...
set CLASSPATH=%CLASSPATH%;%KARAF_HOME%\lib\boot\osgi.core-6.0.0.jar
